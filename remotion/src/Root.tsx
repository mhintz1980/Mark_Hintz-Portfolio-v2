...
import {ShowreelRemixV2Video} from "./ShowreelRemixV2Video";
...
export const RemotionRoot: React.FC = () => {
  return (
    <>
      ...
      {/*
       * ShowreelRemixV2 — iteration sandbox
       * Same scene structure as ShowreelRemix. V2 adds per-scene resumeTextBlocks
       * on the project scene left (image) column. Start with torque wrench (scene index 1).
       * Original ShowreelRemix / ShowreelRemix1080 are NOT changed.
       */}
      <Composition
        id="ShowreelRemixV2"
        component={ShowreelRemixV2Video}
        durationInFrames={TOTAL_FRAMES}
        fps={FPS}
        width={W}
        height={H}
