/**
 * ShowreelRemixV2Video.tsx
 *
 * Identical scene structure to ShowreelRemixVideo.
 * This duplicate exists so we can iterate on new text-cloud treatments
 * in project scenes without touching the original ShowreelRemix composition.
 *
 * V2 additions:
 * - ResumeTextCloud support on the left (image) side of project scenes
 *   with a horizontal fade mask so text dissolves before the right panel
 */
...
export const ShowreelRemixV2Video: React.FC<ShowreelRemixProps> = ({
