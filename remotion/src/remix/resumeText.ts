...
const blockTemplates: Omit<ResumeTextBlock, "text">[] = [
  ...
  {emphasis: "hero",    movement: "drift",    x: 1.05, y: 0.08, startFrame: 0,   endFrame: 300, fontSize: 130, rotate: 0, opacityFrom: 0, opacityTo: 0.18, scaleFrom: 1,    scaleTo: 1,    driftX: -220,  driftY: 0},
  // H-River A foreground read (L→R)
  {emphasis: "accent",  movement: "drift",    x: 1.10, y: 0.20, startFrame: 0,   endFrame: 220, fontSize: 36,  rotate: 0, opacityFrom: 0, opacityTo: 0.88, scaleFrom: 1,    scaleTo: 1,    driftX: -200,  driftY: 0},
  ...
  {emphasis: "accent",  movement: "drift",    x: 0.74, y: -0.38, startFrame: 30, endFrame: 300, fontSize: 100, rotate: 0, opacityFrom: 0, opacityTo: 0.22, scaleFrom: 1,    scaleTo: 1,    driftX: 0,    driftY: 260},
  ...
  {emphasis: "accent",  movement: "drift",    x: 1.12, y: 0.68, startFrame: 100, endFrame: 300, fontSize: 54,  rotate: 0, opacityFrom: 0, opacityTo: 0.88, scaleFrom: 1,    scaleTo: 1,    driftX: -210,  driftY: 0},
  ...
  {emphasis: "accent",  movement: "scale-up", x: 0.68, y: 1.04, startFrame: 168, endFrame: 300, fontSize: 46,  rotate: 0, opacityFrom: 0, opacityTo: 0.84, scaleFrom: 0.90, scaleTo: 1.08, driftX: 0,    driftY: -210},
];
...
// ---------------------------------------------------------------------------
// Armament — project scene text cloud
// ---------------------------------------------------------------------------
export const armamentPhrases = [
  "MIL-SPEC TOLERANCE",
  "MECHANISM DESIGN",
  "REPEATABLE ASSEMBLY",
  "HEAT TREAT STRATEGY",
...
export const defaultArmamentTextBlocks = buildResumeTextBlocks(armamentPhrases);

// ---------------------------------------------------------------------------
// Renderings — project scene text cloud
// ---------------------------------------------------------------------------
export const renderingsPhrases = [
  "REVIEW FIDELITY",
  "GEOMETRY-ACCURATE",
  "STAKEHOLDER CLARITY",
  "ZERO REVISIONS",
...
export const defaultRenderingsTextBlocks = buildResumeTextBlocks(renderingsPhrases);
