...
export const Contact = () => {
  ...
  return (
    <footer
      id="contact"
      className="relative bg-slate-900 dark:bg-[#0F172A] text-white overflow-hidden pt-32 pb-16"
    >
      ...
      <div className="w-full max-w-7xl mx-auto px-8 md:px-20 relative z-10 flex flex-col items-center">
        ...
        >
          <h2 className="font-heading text-5xl md:text-6xl font-extrabold mb-8 tracking-tight">
            {portfolioData.personal.footerCTA}
          </h2>
          <p className="text-xl text-white/70 mb-12">
            Whether you need a SolidWorks macro to eliminate repetitive tasks or
            an end-to-end mechanical design reviewed for manufacturability, I'm
            ready to talk.
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 w-full border-t border-white/10 pt-16 mb-16">
          <div className="text-center md:text-left">
            <h4 className="font-mono text-sm text-accent-secondary uppercase tracking-widest mb-4">
              Location
            </h4>
          ...
          <div className="text-center md:text-left">
            ...
            <a
              href={`mailto:${portfolioData.personal.email}`}
              className="text-lg font-medium hover:text-accent-primary transition-colors block mb-2"
            >
              {portfolioData.personal.email}
            </a>
            <a
              href={`tel:${portfolioData.personal.phone.replace(/[\s()]/g, "")}`}
              className="text-lg font-medium hover:text-accent-primary transition-colors block"
            >
          ...
          <div className="text-center md:text-left">
            ...
            <a
              ...
              className="text-lg font-medium hover:text-accent-primary transition-colors inline-block"
            >
              LinkedIn Profile →
            </a>
          </div>
        ...
        <div className="w-full flex flex-col md:flex-row justify-between items-center text-sm font-mono text-white/50 pt-8 border-t border-white/5">
          <div className="mb-4 md:mb-0">{portfolioData.personal.copyright}</div>
